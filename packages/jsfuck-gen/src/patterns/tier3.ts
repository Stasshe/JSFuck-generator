...
const TIER3: Pattern[] = [
  ...
  },
  {
    ...
    difficulty: 2.5,
    weight: 1,
    cost: CLOSE_BRACKET_EXPR.length,
    tags: ["tier3", "symbol", "from_fill_fn"],
    trapFor: [],
    requires: ["char_f", "char_i", "char_l"],
